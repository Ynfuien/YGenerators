...
public class GeneratorPickUpEvent extends Event implements Cancellable {
    ...
    public GeneratorPickUpEvent(@NotNull Player player, @NotNull PlacedGenerator placedGenerator) {
        super(false);
    ...
    /**
     * @return Player that is picking up the generator
     */
    @NotNull
    ...
    /**
     * @return PlacedGenerator instance that is picked up
     */
